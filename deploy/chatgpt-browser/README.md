...
This image runs one visible Chromium profile, the unpacked AIALRA extension, a loopback bridge and a noVNC desktop. The extension can access only `https://chatgpt.com/*` and its exact loopback bridge origin at `http://127.0.0.1:13216/*`. It does not expose Chrome remote debugging, request the cookies permission, or call private ChatGPT endpoints.
